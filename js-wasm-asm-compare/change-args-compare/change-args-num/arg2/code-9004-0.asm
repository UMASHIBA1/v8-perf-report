...
0x1ca2c6b42ea1     1  4889e5         REX.W movq rbp,rsp ;; rbp = rsp.copy()
0x1ca2c6b42ea4     4  56             push rsi ;; rsi: 関数の第二引数を格納
0x1ca2c6b42ea5     5  57             push rdi ;; rdi: 関数の第一引数を格納


;; ---------- 識別子:1,  arg1とほぼおなじ
0x1ca2c6b42ea6     6  4883ec20       REX.W subq rsp,0x20 ;; rsp = rsp - 32
...
0x1ca2c6b42ec6    26  48c1e820       REX.W shrq rax, 32 ;; rax = rax >> memory(32)
0x1ca2c6b42eca    2a  488b7d10       REX.W movq rdi,[rbp+0x10]
0x1ca2c6b42ece    2e  40f6c701       testb rdi,0x1


;; -------- 識別子2, ここから下arg1と命令とその数変わらない(レジスタの名前は違うのになってるけど命令の意味同じ)
...
0x1ca2c6b42ef6    56  4903d8         REX.W addq rbx,r8 ;; rbx = rbx + r8.value;
0x1ca2c6b42ef9    59  488bf1         REX.W movq rsi,rcx
0x1ca2c6b42efc    5c  488bd7         REX.W movq rdx,rdi ;; たぶんこれとかで一個多く引数渡してる感じ？


;; -------- 識別子3: ここからretまでarg1の場合と変わってない 
0x1ca2c6b42eff    5f  ffd3           call rbx ;; NOTE: callがある
...
0x1ca2c6b42f1e    7e  c21800         ret 0x18 ;; NOTE: retがある
...
0x1ca2c6b42f3a    9a  41ff94fdc8320000 call [r13+rdi*8+0x32c8] ;; NOTE: callがある
...
0x1ca2c6b42f6f    cf  43ff94c5c8320000 call [r13+r8*8+0x32c8] ;; NOTE: callがある
