...
0x2270fb143017    17  55             push rbp ; 呼び出し元に戻るときに使うため呼び出し元のrbp(ベースポインタ)をスタックにプッシュ (参考: https://qiita.com/tobira-code/items/75d3034aed8bb9828981#%E3%83%AC%E3%82%B8%E3%82%B9%E3%82%BF)
0x2270fb143018    18  4889e5         REX.W movq rbp,rsp ; スタックのトップのポインタを表すrspをこの関数のベースポインタとしてrbpにコピー
0x2270fb14301b    1b  56             push rsi ; ソースコードポインタであるrsiをpush
0x2270fb14301c    1c  57             push rdi ; rdiをpush
;現状: stack初めの方 [rbp(関数呼び出し元のポインタ)の値, rsi(ソースコードポインタ)の値, rdiの値] 後の方
0x2270fb14301d    1d  48ba0000000021000000 REX.W movq rdx,0x2100000000 ; rdx = 0x2100000000
0x2270fb143027    27  49baa0fd3d0100000000 REX.W movq r10,0x13dfda0  (Abort) ; r10 = 0x13dfda0
0x2270fb143031    31  41ffd2         call r10 ; TODO: r10 = 0x13dfda0だが0x13dfda0がこのファイル上に見つからない、どうなってるのか考える
...
0x2270fb143540     0  488b59c0       REX.W movq rbx,[rcx-0x40] ; rbx = rcx - 0x40
